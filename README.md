...
- You can try it out here: **https://techie.devailab.work/mcp** but you must (**1**) first connect to your AI assistant (ChatGPT, Claude, or Mistral AI Le Chat) and (**2**) be authenticated.
